...
public class SecondFragment extends Fragment {
    ...
    private void dataInitialize() {
        ...
        logos = new int[]{
                R.drawable.bd_logo_1,
                R.drawable.bd_logo_2,
                R.drawable.bd_logo_3,
                R.drawable.bd_logo_4,
                R.drawable.bd_logo_5,
                R.drawable.bd_logo_6,
                R.drawable.bd_logo_7,
                R.drawable.bd_logo_8,
                R.drawable.bd_logo_9,
                R.drawable.bd_logo_10,
        };
